...
function uploadFileWithProgress(file: File): Promise<void> {
  return new Promise((resolve, reject) => {
    ...
    const url = `${API_BASE}/api/admin/individual-submission/${individualSubmissionId.value}`
    xhr.open('POST', url)
...
async function submitVideoLink() {
  ...
  try {
    if (file) {
      ...
      await $fetch(`${API_BASE}/api/admin/individual-submission/${individualSubmissionId.value}/link`, {
        method: 'PATCH',
        headers: { Authorization: `${useAuthToken().value}` },
    ...
    await refreshNuxtData(`individual-submission-${individualSubmissionId.value}`)
  } catch (e) {
...
async function markAsLiveSubmission(close: () => void) {
  ...
  try {
    await $fetch(`${API_BASE}/api/admin/individual-submission/${individualSubmissionId.value}/live`, {
      method: 'PATCH',
      headers: { Authorization: `${useAuthToken().value}` },
    })
    await refreshNuxtData(`individual-submission-${individualSubmissionId.value}`)
...
async function submitRubricAnswers() {
  ...
  try {
    await $fetch(`${API_BASE}/api/admin/individual-submission/${individualSubmissionId.value}`, {
      method: 'PATCH',
      headers: { Authorization: `${useAuthToken().value}` },
...
async function submitReject() {
  ...
  try {
    await $fetch(`${API_BASE}/api/admin/individual-submission/${individualSubmissionId.value}/reject`, {
      method: 'PATCH',
      headers: { Authorization: `${useAuthToken().value}` },
...
async function generateAnalysis() {
  ...
  try {
    await $fetch(`${API_BASE}/api/admin/individual-submission/${individualSubmissionId.value}/analysis`, {
      method: 'PATCH',
      headers: { Authorization: `${useAuthToken().value}` },
    })
    await refreshNuxtData(`individual-submission-${individualSubmissionId.value}`)
...
async function submitOverrideAnalysis() {
  ...
  try {
    await $fetch(`${API_BASE}/api/admin/individual-submission/${individualSubmissionId.value}/override`, {
      method: 'PATCH',
      headers: { Authorization: `${useAuthToken().value}` },
