...
const { data: student, status, refresh: refreshStudent } = await useAsyncData<StudentDetail>(
  ...
  () => $fetch(`${API_BASE}/api/teacher/students/${studentId.value}`, {
    headers: {
...
const { data: allSections } = await useAsyncData<SectionOption[]>(
  'all-sections',
  () => $fetch(`${API_BASE}/api/teacher/sections`, {
    headers: { Authorization: `${useAuthToken().value}` }
  }),
  {
...
async function confirmAssignSection() {
  ...
  try {
    await $fetch(`${API_BASE}/api/teacher/sections/${assignSectionSelectedId.value}/assign-student/${studentId.value}`, {
      method: 'POST',
      headers: { Authorization: `${useAuthToken().value}` }
    })
...
function openAssignInstrumentModal() {
  ...
  $fetch(`${API_BASE}/api/teacher/instruments`, {
    headers: { Authorization: `${useAuthToken().value}` }
  })
    .then((response: any) => {
...
async function confirmAssignInstrument() {
  ...
  try {
    ...
    await $fetch(`${API_BASE}/api/teacher/student-instrument`, {
      method: 'POST',
      headers: { Authorization: `${useAuthToken().value}` },
      body,
    })
...
async function confirmUnassignInstrument() {
  ...
  try {
    await $fetch(`${API_BASE}/api/teacher/student-instrument/${instrumentToUnassign.value._id}`, {
      method: 'DELETE',
      headers: { Authorization: `${useAuthToken().value}` },
    })
    isUnassignInstrumentOpen.value = false
...
async function confirmAssignAssessment() {
  ...
  try {
    await $fetch(`${API_BASE}/api/teacher/assessment-students`, {
      method: 'POST',
      headers: { Authorization: `${useAuthToken().value}` },
...
async function confirmUnassignAssessment() {
  ...
  try {
    await $fetch(`${API_BASE}/api/teacher/assessment-students/${assignmentId}`, {
      method: 'DELETE',
      headers: { Authorization: `${useAuthToken().value}` },
    })
    isUnassignAssessmentOpen.value = false
...
async function confirmAssignGuardian() {
  ...
  try {
    await $fetch(`${API_BASE}/api/teacher/student-guardian/assign`, {
      method: 'POST',
      headers: { Authorization: `${useAuthToken().value}` },
      body: {
...
async function generateAnalysis() {
  ...
  try {
    const response = await $fetch(`${API_BASE}/api/teacher/students/${studentId.value}/summarize`, {
      method: 'PATCH',
      headers: { Authorization: `${useAuthToken().value}` },
    })
...
async function submitOverrideAnalysis() {
  ...
  try {
    await $fetch(`${API_BASE}/api/teacher/students/${studentId.value}/override`, {
      method: 'PATCH',
      headers: { Authorization: `${useAuthToken().value}` },
...
const { data: guardians, status: guardiansStatus, refresh: refreshGuardians } = await useAsyncData<GuardianInfo[]>(
  ...
  () => $fetch(`${API_BASE}/api/teacher/student-guardian/${studentId.value}/guardians`, {
    headers: {
      Authorization: `${useAuthToken().value}`
    },
    onResponse({ response }) {
...
async function confirmUnassignGuardian() {
  ...
  try {
    await $fetch(`${API_BASE}/api/teacher/student-guardian/unassign`, {
      method: 'DELETE',
      headers: { Authorization: `${useAuthToken().value}` },
      body: {
        studentId: studentId.value,
...
const { data: instruments, status: instrumentsStatus, refresh: refreshInstruments } = await useAsyncData<InstrumentInfo[]>(
  ...
  () => $fetch(`${API_BASE}/api/teacher/student-instrument/${studentId.value}`, {
    headers: {
      Authorization: `${useAuthToken().value}`
    },
    onResponse({ response }) {
...
const { data: studentAssessments, status: studentAssessmentsStatus, refresh: refreshStudentAssessments } = await useAsyncData<Assessment[]>(
  ...
  () => $fetch(`${API_BASE}/api/teacher/assessment-students/${studentId.value}`, {
    headers: {
      Authorization: `${useAuthToken().value}`
    },
    onResponse({ response }) {
...
const { data: specialSubmissionsRaw, status: specialSubmissionsStatus, refresh: refreshSpecialSubmissions } = await useAsyncData<SpecialSubmission[]>(
  ...
  () => $fetch(`${API_BASE}/api/teacher/special-submission/student/${studentId.value}`, {
    headers: {
      Authorization: `${useAuthToken().value}`
    },
    onResponse({ response }) {
...
const { data: individualSubmissionsRaw, status: individualSubmissionsStatus } = await useAsyncData<IndividualSubmission[]>(
  ...
  () => $fetch(`${API_BASE}/api/teacher/individual-submission/student/${studentId.value}`, {
    headers: {
      Authorization: `${useAuthToken().value}`
    },
    onResponse({ response }) {
...
const { data: journalEntries, status: journalEntriesStatus } = await useAsyncData<JournalEntry[]>(
  ...
  () => $fetch(`${API_BASE}/api/teacher/journal-entry/student/${studentId.value}`, {
    headers: {
      Authorization: `${useAuthToken().value}`
    },
    onResponse({ response }) {
