...
const { data, status } = await useAsyncData('journals',
  () => $fetch('https://noteworthy-z9k0.onrender.com/api/teacher/journals', {
    headers: {
  ...
  }),
  {
    transform: (response: any): Journals[] => {
      ...
      // The /api/teacher/journals endpoint returns a direct list of journal templates.
    ...
    <UPageCard>
        ...
        <div style="margin-left: auto">
          <UInput :model-value="table1?.tableApi?.getColumn('title')?.getFilterValue() as string" class="max-w-sm mr-5"
            ...
            <UButton label="Add New Journal" to="../teacher-interface/t-create-journal"/>
